...
(function($) {
	...
	youtubePlayers.forEach(function(youtubePlayer) {
		...
		let previewImg = youtubePlayer.querySelector("img");
		if(!previewImg) {
		...
		youtubePlayer.addEventListener("click", function() {
			var iframe = document.createElement('iframe');
			iframe.width = "100%";
			iframe.height = "100%";
			iframe.setAttribute(
				'src',
				'https://www.youtube-nocookie.com/embed/' + youtubePlayer.dataset.src + '?autoplay=1&rel=0&enablejsapi=1'
			);
